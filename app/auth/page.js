...
// 1. Move all the form logic to an inner component
function AuthForm() {
  ...
  return (
    <div style={{ background: '#0e111a', border: '1px solid rgba(255,255,255,0.06)', width: '100%', maxWidth: '400px', borderRadius: '24px', padding: '30px', boxShadow: '0 20px 50px rgba(0,0,0,0.5)' }}>
      ...
      <div style={{ display: 'flex', background: 'rgba(0,0,0,0.3)', padding: '4px', borderRadius: '10px', marginBottom: '24px' }}>
        <button type="button" onClick={() => { setActiveTab('login'); setErrorMsg(''); }} style={{ flex: 1, padding: '10px', background: activeTab === 'login' ? 'rgba(255,255,255,0.06)' : 'transparent', border: 'none', color: '#fff', fontSize: '13px', fontWeight: '800', borderRadius: '8px', cursor: 'pointer' }}>Login</button>
        <button type="button" onClick={() => { setActiveTab('signup'); setErrorMsg(''); }} style={{ flex: 1, padding: '10px', background: activeTab === 'signup' ? 'rgba(255,255,255,0.06)' : 'transparent', border: 'none', color: '#fff', fontSize: '13px', fontWeight: '800', borderRadius: '8px', cursor: 'pointer' }}>Register</button>
      </div>
...
// 2. Main export wraps the inner component in a Suspense boundary
